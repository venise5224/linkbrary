  ...
  return (
    <div className="flex items-center justify-between bg-gray300 rounded-lg px-6 py-3 mt-8">
      ...
      <div className="flex gap-4">
        <Link
          href={`https://accounts.google.com/o/oauth2/v2/auth?scope=https://www.googleapis.com/auth/userinfo.profile&response_type=code&redirect_uri=http://localhost:3000/api/auth/sign-in/google&client_id=${process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID}`}
        >
