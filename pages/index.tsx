...
const HomePage = () => {
  ...
  return (
    <>
      <Head>
        <title>Linkbrary - 나만의 링크를 간편하게 관리하는 서비스</title>
        <meta
          name="description"
          content="Linkbrary는 사용자가 다양한 링크를 쉽고 빠르게 관리할 수 있는 웹 기반 플랫폼입니다. 지금 바로 시작하세요!"
        />
      </Head>
      <main>
        ...
        <div className="flex flex-col items-center gap-[80px] px-[33px] pt-[40px] pb-[80px] md:pt-[80px] md:pb-[170px] md:gap-[100px] lg:pt-[120px]">
          <section className={sectionStyle}>
            <div className={sectionContent}>
              ...
              <em className={sectionDescriptionStyle}>
                ...
                <br className="sm:block md:hidden lg:hidden" /> 기억하고 싶은
                모든 것을 한 공간에 저장하세요.
              </em>
            </div>
            <Image
          ...
          >
            <div className={sectionContent}>
              ...
              <em className={sectionDescriptionStyle}>
                ...
                <br className="sm:block md:hidden lg:hidden" /> 있습니다.
              </em>
            </div>
            <Image
              src={sectionFolder}
          ...
          <section className={sectionStyle}>
            <div className={sectionContent}>
              <strong className={sectionTitleStyle}>
                저장한 링크를 <span className="gradient-text">공유</span>해
                보세요
              </strong>
              <em className={sectionDescriptionStyle}>
                여러 링크를 폴더에 담고 공유할 수 있습니다. 가족,
                <br className="sm:block md:hidden lg:hidden" /> 친구, 동료들에게
                쉽고 빠르게 링크를 공유해 보세요.
              </em>
            </div>
            <Image
          ...
          >
            <div className={sectionContent}>
              <strong className={sectionTitleStyle}>
                저장한 링크를 <span className="gradient-text">검색</span>해
                보세요
              </strong>
              <em className={sectionDescriptionStyle}>
